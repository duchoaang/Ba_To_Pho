...
<div id="icon"></div>`;var F=I(function(_){function A(){(function(O,y){if(!(O instanceof y))throw new TypeError("Cannot call a class as a function")})(this,A);var j=function(O,y){if(!O)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!y||typeof y!="object"&&typeof y!="function"?O:y}(this,(A.__proto__||Object.getPrototypeOf(A)).call(this));return j.$ui=j.attachShadow({mode:"open"}),j.$ui.appendChild(j.ownerDocument.importNode(D.content,!0)),z()&&H.ShadyCSS.styleElement(j),j._state={$iconHolder:j.$ui.getElementById("icon"),type:j.getAttribute("type")},j}return function(j,O){if(typeof O!="function"&&O!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof O);j.prototype=Object.create(O&&O.prototype,{constructor:{value:j,enumerable:!1,writable:!0,configurable:!0}}),O&&(Object.setPrototypeOf?Object.setPrototypeOf(j,O):j.__proto__=O)}(A,HTMLElement),B(A,null,[{key:"getIconSvg",value:function(j,O){var y=this.cdnUrl+"/regular/bx-"+j+".svg";return O==="solid"?y=this.cdnUrl+"/solid/bxs-"+j+".svg":O==="logo"&&(y=this.cdnUrl+"/logos/bxl-"+j+".svg"),y&&T[y]||(T[y]=new Promise(function(J,ne){var oe=new XMLHttpRequest;oe.addEventListener("load",function(){this.status<200||this.status>=300?ne(new Error(this.status+" "+this.responseText)):J(this.responseText)}),oe.onerror=ne,oe.onabort=ne,oe.open("GET",y),oe.send()})),T[y]}},{key:"define",value:function(j){j=j||this.tagName,z()&&H.ShadyCSS.prepareTemplate(D,j),customElements.define(j,this)}},{key:"cdnUrl",get:function(){return"//unpkg.com/boxicons@2.1.4/svg"}},{key:"tagName",get:function(){return"box-icon"}},{key:"observedAttributes",get:function(){return["type","name","color","size","rotate","flip","animation","border","pull"]}}]),B(A,[{key:"attributeChangedCallback",value:function(j,O,y){var J=this._state.$iconHolder;switch(j){case"type":(function(ne,oe,q){var N=ne._state;N.$iconHolder.textContent="",N.type&&(N.type=null),N.type=!q||q!=="solid"&&q!=="logo"?"regular":q,N.currentName!==void 0&&ne.constructor.getIconSvg(N.currentName,N.type).then(function(le){N.type===q&&(N.$iconHolder.innerHTML=le)}).catch(function(le){console.error("Failed to load icon: "+N.currentName+`
`+le)})})(this,0,y);break;case"name":(function(ne,oe,q){var N=ne._state;N.currentName=q,N.$iconHolder.textContent="",q&&N.type!==void 0&&ne.constructor.getIconSvg(q,N.type).then(function(le){N.currentName===q&&(N.$iconHolder.innerHTML=le)}).catch(function(le){console.error("Failed to load icon: "+q+`
`+le)})})(this,0,y);break;case"color":J.style.fill=y||"";break;case"size":(function(ne,oe,q){var N=ne._state;N.size&&(N.$iconHolder.style.width=N.$iconHolder.style.height="",N.size=N.sizeType=null),q&&!/^(xs|sm|md|lg)$/.test(N.size)&&(N.size=q.trim(),N.$iconHolder.style.width=N.$iconHolder.style.height=N.size)})(this,0,y);break;case"rotate":O&&J.classList.remove("bx-rotate-"+O),y&&J.classList.add("bx-rotate-"+y);break;case"flip":O&&J.classList.remove("bx-flip-"+O),y&&J.classList.add("bx-flip-"+y);break;case"animation":O&&J.classList.remove("bx-"+O),y&&J.classList.add("bx-"+y)}}},{key:"connectedCallback",value:function(){z()&&H.ShadyCSS.styleElement(this)}}]),A}());s.default=F,F.define()}])},t.exports=a()})})(af);const ie=Xn.bind(wl),of=[{icon:"apps",title:"Tất cả môn học",subItem:[]},{icon:"business_center",title:"Việc kinh doanh",subItem:[]},{icon:"public",title:"Nhân văn",subItem:[]},{icon:"calculate",title:"Toán học",subItem:[]},{icon:"terminal",title:"Lập trình",subItem:["Lập trình C/C++","Lập trình Python","Lập trình Java","Lập trình JavaScript"]},{icon:"science",title:"Khoa học",subItem:[]},{icon:"create",title:"Viết",subItem:[]}],sf=({data:t})=>m.jsxs("li",{className:ie("sub-menu"),children:[m.jsxs("div",{className:"d-flex align-items-center pb-2",children:[t.icon?m.jsx("span",{className:"material-icons",style:{color:"#1ab9f4"},children:t.icon}):null,m.jsx("span",{className:"ms-1",children:t.title}),t.subItem?m.jsx("span",{className:"material-icons",children:"arrow_drop_down"}):null]}),m.jsx("ul",{className:"bg-white",children:t.subItem.map((r,a)=>m.jsx("li",{className:"py-2 ps-4 pe-3",children:r},a))})]}),Da=({show:t,children:r})=>m.jsx("div",{className:ie("modal-wrapper",{show:t}),children:r}),lf=()=>{const[t,r]=$.useState(!1),[a,i]=$.useState([]),[s,u]=$.useState(null),[l,d]=$.useState([]),[p,f]=$.useState([]),[g,b]=$.useState([]);$.useState("");const[w,k]=$.useState(!1),[S,B]=$.useState(!1),[I,H]=$.useState(""),[T,D]=$.useState(""),[z,F]=$.useState(""),[_,A]=$.useState(""),[j,O]=$.useState(!1),[y,J]=$.useState(!1),[ne,oe]=$.useState(!1),[q,N]=$.useState(!1);$.useState(!1);const[le,Oe]=$.useState(!1),[ce,ue]=$.useState(!1),[be,jt]=$.useState(!1);$.useState([]);const[Se,ye]=$.useState(!1),_t=Ks({onSuccess:P=>i(P),onError:P=>console.log("Login Failed:",P)}),Ee=!!s,it=P=>{u(P.currentTarget)},Pe=()=>{u(null)};$.useEffect(()=>{a!=null&&ht.get(`https://www.googleapis.com/oauth2/v1/userinfo?access_token=${a.access_token}`,{headers:{Authorization:`Bearer ${t.access_token}`,Accept:"application/json"}}).then(P=>{b(P.data)}).catch(P=>{})},[a]),$.useEffect(()=>{g&&ht.post("http://127.0.0.1:5000/users/loginGoogle",g,{withCredentials:!0}).then(P=>{r(!0),f({id:P.data.id,name:P.data.name,avatar:P.data.avatar}),k(!1),ye(!1)}).catch(P=>{console.log("dang nhap k thanh cong")})},[g]),$.useEffect(()=>{ht.get("http://127.0.0.1:5000/current-user",{withCredentials:!0}).then(P=>{P.data.is_active===!0&&(r(!0),d({id:P.data.id,username:P.data.username,avatar:P.data.avatar}))})},[t]);const ot=()=>{Ge.fire({icon:"success",title:"Đăng kí thành công",text:"Chúc bạn có một trải nghiệm tốt lành!",willClose:Oe(!1)})},st=()=>{let P;Ge.fire({title:"Xác nhận email !",html:"Hãy xác nhận email của bạn trong <b></b> giây .",timer:5e3,timerProgressBar:!0,didOpen:()=>{Ge.showLoading();const U=Ge.getHtmlContainer().querySelector("b");let Y;P=setInterval(()=>{Y=Math.floor(Ge.getTimerLeft()/1e3),U.textContent=Y},1e3)},willClose:()=>{N(!1),clearInterval(P)}}).then(U=>{U.dismiss===Ge.DismissReason.timer&&console.log("I was closed by the timer")})};$.useEffect(()=>{J(I!==""&&T!==""&&z!==""&&_!==""&&j)},[I,T,z,_,j]);const[He,un]=$.useState({name:I,email:z,password:T}),[re,pe]=$.useState({username:I,password:T}),fn=()=>{k(!0),B(!1)};$.useEffect(()=>{S?un({name:I,email:z,password:T}):pe({username:I,password:T})},[I,z,T]),$.useEffect(()=>{if(q===!0&&q===!0){const U=setInterval(()=>{fetch("http://127.0.0.1:5000/users/confirm-status/",{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"}).then(Y=>Y.json()).then(Y=>{Y.status===200?(clearInterval(U),N(!1),ue(!1),Oe(!0),console.log(" xac thuc email thanh cong")):Y.status===404?console.log("That bai"):console.log("12123")})},3e3);setTimeout(()=>{clearInterval(U)},5e3)}},[q]);const ae=P=>{P.preventDefault(),T===_?(ue(!0),oe(!1),fetch("http://127.0.0.1:5000/users/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(He)}).then(U=>U.json()).then(U=>{U.status===200?(B(!1),console.log("dang ki thanh cong"),N(!0)):U.status===404&&(console.log("dang ki That bai"),ue(!1),jt(!0),N(!1))}).catch(U=>{})):oe(!0)},lt=P=>{P.preventDefault(),ht.post("http://127.0.0.1:5000/users/login",re,{withCredentials:!0}).then(U=>{r(!0),d({id:U.data.id,username:U.data.username,avatar:U.data.avatar}),k(!1),ye(!1)}).catch(U=>{ye(!0),console.log("dang nhap k thanh cong")})},ct=()=>{jt(!1),D(""),F(""),H(""),A(""),ue(!1),k(!1),B(!0)},ut=()=>{H(""),B(!1),k(!1)},M=()=>{ue(!1)},me=()=>{ht.post("http://127.0.0.1:5000/users/logout",l.id,{withCredentials:!0}).then(P=>{}).catch(P=>{}),r(!1)};return m.jsxs(m.Fragment,{children:[le&&m.jsx(ot,{onClose:M}),m.jsx(Da,{show:w,children:m.jsxs("div",{className:ie("modal-inner"),children:[m.jsx("h2",{children:"Đăng nhập bằng "}),Se&&m.jsx("h2",{style:{fontSize:"16px",color:"red"},children:"Tài khoản hoặc mật khẩu sai !"}),m.jsx("span",{className:ie("cancel","material-icons"),onClick:ut,children:"cancel"}),m.jsx("div",{className:"d-flex g-2 justify-content-center",children:m.jsx("div",{id:"signInGoogle",children:m.jsx(m.Fragment,{children:m.jsx(Ql,{type:"dark",label:"Đăng nhập với Google ",size:"small",onClick:()=>_t()})})})}),m.jsx("p",{className:"mt-3",children:"hoặc"}),m.jsxs("form",{onSubmit:lt,children:[m.jsxs("div",{className:"mb-3 text-start",children:[m.jsx("label",{htmlFor:"login-email",className:"form-label",children:"Tên người dùng hoặc email"}),m.jsx("input",{onChange:P=>H(P.target.value),type:"text",className:"form-control",id:"login-email",placeholder:"Tên tài khoản..."})]}),m.jsxs("div",{className:"text-start",children:[m.jsx("label",{htmlFor:"login-password",className:"form-label",children:"Mật khẩu"}),m.jsx("input",{onChange:P=>D(P.target.value),type:"password",className:"form-control",id:"login-password",placeholder:"Mật khẩu..."})]}),m.jsxs("div",{className:"d-flex justify-content-between mt-3",children:[m.jsxs("div",{children:[m.jsx("input",{type:"checkbox",id:"login-remember",name:"login-remember"}),m.jsx("label",{htmlFor:"login-remember",children:"Ghi nhớ tôi"})]}),m.jsx(Ke,{to:"/",children:"Quên mật khẩu"})]}),m.jsx(Sn,{className:"w-100 mt-3",children:"ĐĂNG NHẬP"})]}),m.jsxs("p",{className:"text-center mt-3",children:["Đây là lần đầu tiên của bạn? ",m.jsx("b",{style:{cursor:"pointer"},onClick:ct,children:"Đăng ký ngay"})]})]})}),m.jsx(Da,{show:S,children:m.jsxs("div",{className:ie("modal-inner"),style:{height:"550px"},children:[m.jsx("h2",{children:"Đăng ký"}),ne&&m.jsx("h2",{style:{fontSize:"18px",color:"red",fontWeight:"600"},children:"Xác nhận mật khẩu không đúng !!"}),m.jsx("span",{className:ie("cancel","material-icons"),onClick:ut,children:"cancel"}),be&&m.jsxs("h2",{style:{fontSize:"18px",color:"red",fontWeight:"600"},children:["Tên người dùng hoặc email đã được sử dụng"," "]}),m.jsxs("form",{onSubmit:ae,children:[m.jsxs("div",{className:"mb-3 text-start",children:[m.jsx("label",{htmlFor:"register-username",className:"form-label",children:"Tên người dùng của bạn"}),m.jsx("input",{value:I,type:"text",onChange:P=>H(P.target.value),className:"form-control",id:"register-username",placeholder:"username"})]}),m.jsxs("div",{className:"mb-3 text-start",children:[m.jsx("label",{htmlFor:"register-email",className:"form-label",children:"Email của bạn"}),m.jsx("input",{value:z,type:"email",onChange:P=>F(P.target.value),className:"form-control",id:"register-email",placeholder:"name@example.com"})]}),m.jsxs("div",{className:"text-start",children:[m.jsx("label",{htmlFor:"register-password",className:"form-label",children:"Mật khẩu"}),m.jsx("input",{value:T,onChange:P=>D(P.target.value),type:"password",className:"form-control",id:"register-password"})]}),m.jsxs("div",{className:"text-start",children:[m.jsx("label",{htmlFor:"register-confirm-password",className:"form-label",children:"Xác nhận mật khẩu"}),m.jsx("input",{value:_,onChange:P=>A(P.target.value),type:"password",className:"form-control",id:"register-confirm-password"})]}),m.jsx("div",{className:"d-flex justify-content-between mt-3",children:m.jsxs("div",{children:[m.jsxs("label",{htmlFor:"acp-policy",style:{marginRight:"10px"},children:["Bạn đã đọc và đồng ý ",m.jsx(Ke,{to:"/",children:"điều khoản"})," của Ba Tô Phở"," "]}),m.jsx("input",{onChange:()=>O(!j),type:"checkbox",id:"acp-policy",name:"acp-policy"})]})}),m.jsxs(Sn,{type:"submit",className:"w-100 mt-3",disabled:!y,onClick:ae,children:[" ",m.jsxs("h1",{className:ie("register"),children:["ĐĂNG KÝ"," ",ce&&m.jsx("span",{className:ie("loading","material-icons"),children:"refresh"})]})]})]}),m.jsxs("p",{className:"text-center mt-3",style:{paddingBottom:"20px"},children:["Bạn đã có tài khoản? ",m.jsx("b",{style:{cursor:"pointer"},onClick:fn,children:"Đăng nhập"})]})]})}),q&&m.jsx(st,{}),m.jsxs("header",{className:ie("wrapper"),children:[m.jsx("div",{className:ie("logo"),children:m.jsx(Ke,{to:"/",children:m.jsx("img",{src:"/src/assets/logo.png",alt:"Logo",className:"w-100 h-100"})})}),m.jsxs("div",{className:ie("input","d-flex align-items-center"),style:{height:"40%"},children:[m.jsxs("select",{className:"form-select",children:[m.jsx("option",{value:"1",children:"Các tài liệu"}),m.jsx("option",{value:"2",children:"Câu hỏi"}),m.jsx("option",{value:"3",children:"Giáo sư"})]}),m.jsxs("div",{className:ie("search"),children:[m.jsx(Al,{placeholder:"12123123"}),m.jsx("span",{className:"material-icons",onClick:()=>Oe(!0),children:"search"})]}),m.jsx("button",{className:"btn"})]}),m.jsxs("div",{className:ie("actions"),children:[m.jsx(Ke,{to:"/upload",children:m.jsx(Sn,{className:"me-5 btn btn-warning border",children:"Tải lên"})}),t?m.jsxs(m.Fragment,{children:[m.jsx(Js,{sx:{display:"flex",alignItems:"center",textAlign:"center"},children:m.jsx(Zs,{title:"Account settings",children:m.jsx(nl,{onClick:it,size:"small",sx:{ml:2},"aria-controls":Ee?"account-menu":void 0,"aria-haspopup":"true","aria-expanded":Ee?"true":void 0,children:m.jsx(On,{sx:{width:32,height:32},children:m.jsx("img",{className:ie("user_avatar"),src:l.avatar,alt:""})})})})}),m.jsxs(rl,{anchorEl:s,id:"account-menu",open:Ee,onClose:Pe,onClick:Pe,PaperProps:{elevation:0,sx:{overflow:"visible",filter:"drop-shadow(0px 2px 8px rgba(0,0,0,0.32))",mt:1.5,"& .MuiAvatar-root":{width:32,height:32,ml:-.5,mr:1},"&:before":{content:'""',display:"block",position:"absolute",top:0,right:14,width:10,height:10,bgcolor:"background.paper",transform:"translateY(-50%) rotate(45deg)",zIndex:0}}},transformOrigin:{horizontal:"right",vertical:"top"},anchorOrigin:{horizontal:"right",vertical:"bottom"},children:[m.jsx(Ke,{style:{color:"black"},to:`/profile/${l.id}`,children:m.jsxs(gt,{onClick:Pe,children:[m.jsx(On,{})," Profile"]})}),m.jsxs(gt,{onClick:Pe,children:[m.jsx(On,{})," My account"]}),m.jsx(al,{}),m.jsxs(gt,{onClick:Pe,children:[m.jsx(Cn,{children:m.jsx(Oi,{fontSize:"small"})}),"Add another account"]}),m.jsxs(gt,{onClick:Pe,children:[m.jsx(Cn,{children:m.jsx(Si,{fontSize:"small"})}),"Settings"]}),m.jsxs(gt,{onClick:me,children:[m.jsx(Cn,{children:m.jsx(Ei,{fontSize:"small"})}),"Logout"]})]})]}):m.jsxs(m.Fragment,{children:[m.jsx(ia,{variant:"contained",className:"me-2",color:"info",onClick:()=>{k(!0)},children:"Đăng nhập"}),m.jsx(ia,{variant:"contained",color:"inherit",className:"me",onClick:ct,children:"Đăng ký"})]})]})]}),m.jsx("ul",{className:ie("menu","d-flex justify-content-around mt-2"),children:of.map((P,U)=>m.jsx(sf,{data:P},U))})]})},cf=()=>m.jsxs(Qs,{bgColor:"light",className:"text-center text-lg-start text-muted",children:[m.jsx("section",{className:"",style:{background:"#011b30",color:"white",paddingTop:"8px"},children:m.jsx(el,{className:"text-center text-md-start mt-5",children:m.jsxs(tl,{className:"mt-3",children:[m.jsxs($t,{md:"3",lg:"4",xl:"3",className:"mx-auto mb-4",children:[m.jsxs("h6",{className:"text-uppercase fw-bold mb-4",children:[m.jsx(Bt,{icon:"gem",className:"me-3"}),"Ba To Pho"]}),m.jsx("p",{children:'"Kiến thức là sức mạnh", vì vậy để chúng tôi cùng phát triển sức mạnh cùng bạn qua chặng đường học tập cùng với những tài liệu'})]}),m.jsxs($t,{md:"2",lg:"2",xl:"2",className:"mx-auto mb-4",children:[m.jsx("h6",{className:"text-uppercase fw-bold mb-4",children:"Products"}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Facebook"})}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Insagram"})}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Zalo"})}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Twiter"})})]}),m.jsxs($t,{md:"3",lg:"2",xl:"2",className:"mx-auto mb-4",children:[m.jsx("h6",{className:"text-uppercase fw-bold mb-4",children:"Useful links"}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Pricing"})}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Settings"})}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Orders"})}),m.jsx("p",{children:m.jsx("a",{href:"#!",className:"text-reset",children:"Help"})})]}),m.jsxs($t,{md:"4",lg:"3",xl:"3",className:"mx-auto mb-md-0 mb-4",children:[m.jsx("h6",{className:"text-uppercase fw-bold mb-4",children:"Liên hệ"}),m.jsxs("p",{children:[m.jsx(Bt,{icon:"home",className:"me-2"}),"TP Hồ Chí Minh, Gò Vấp, Phường 3"]}),m.jsxs("p",{children:[m.jsx(Bt,{icon:"envelope",className:"me-3"}),"codeheroes@gmail.com"]}),m.jsxs("p",{children:[m.jsx(Bt,{icon:"phone",className:"me-3"}),"0941720502"]})]})]})})}),m.jsxs("div",{className:"text-center p-4",style:{background:"#011b30",color:"white",paddingTop:"8px"},children:["© 2023 Copyright:",m.jsx("a",{className:"text-reset fw-bold",href:"https://codeheroes.com/",children:"Codeheroes.com"})]})]}),uf=({children:t})=>m.jsxs(m.Fragment,{children:[m.jsx(lf,{}),m.jsx("div",{className:"vw-100 overflow-hidden my-4",children:t}),m.jsx(cf,{})]}),Of=uf;export{Of as default};
